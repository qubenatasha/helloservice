...
HELLO_VERSION = "/v1/helloservice/version"
...
class TestHelloServiceVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_helloservice_default_version(self, *args, **kwargs):
    ...
    def test_helloservice_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
