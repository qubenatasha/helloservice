...
from qube.src.api.helloservicecontroller import HelloServiceController
from qube.src.api.helloservicecontroller import HelloServiceItemController
from qube.src.api.versioncontroller import HelloServiceItemVersionController
...
api.add_resource(HelloServiceItemVersionController, '/v1/helloservice/version')
api.add_resource(HelloServiceController, '/v1/helloservice')
api.add_resource(HelloServiceItemController, '/v1/helloservice/<string:entity_id>')
